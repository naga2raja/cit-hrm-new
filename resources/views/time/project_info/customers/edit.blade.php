								...
								<div class="card-body">
									...
									<form method="POST" action="{{ route('customers.update', $customers[0]->id) }}">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
													<input type="text" class="form-control {{ $errors->has('customer_name') ? 'is-invalid' : ''}}" placeholder="" name="customer_name" id="customer_name" value="{{ old('customer_name', $customers[0]->customer_name) }}" maxlength="30" autocomplete="off" onkeyup="allowCharactersWithSpace('customer_name')">
