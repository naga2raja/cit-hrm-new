								...
								<div class="card-body">									
									<form method="POST" action="{{ route('customers.store') }}">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
													<input type="text" class="form-control {{ $errors->has('customer_name') ? 'is-invalid' : ''}}" placeholder="" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" maxlength="30" autocomplete="off" onfocus="allowCharactersWithSpace('customer_name')">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
													<textarea class="form-control {{ $errors->has('customer_description') ? 'is-invalid' : ''}}" rows="3" name="customer_description" maxlength="255">{{ old('customer_description') }}</textarea>
