						...
						<div class="col-xl-9 col-lg-8  col-md-12">
							<div class="card ctm-border-radius shadow-sm">
									<div class="card-header">
										<h4 class="card-title mb-0 d-inline-block">Import Projects</h4>
									</div>
									<div class="card-body">
										...
										@endif
											...
											<form method="POST" enctype="multipart/form-data" action="{{ route('projects.insert') }}">
												@csrf
												<div class="row">
													<div class="col-md-12">
													...
													<div class="col-md-12">
														<ul class="list-group">
                                                            ...
                                                            <li  class="list-group-item">Project name and Customer name are compulsory</li>
                                                            <li  class="list-group-item">If Project Managers or Employees specified Employee Ids should be comma separated format.</li>
															<li  class="list-group-item">Sample Excel file:                         
																<a title="Download" target="_blank" class="download" href="{{ assetUrl('sample/projects-import.xls') }}">Download</a>
															</li>
														 </ul>
													</div>
												</div>
															...
															<div class="row">
																...
																<tbody>';                    
																		foreach ($output['errors'] as $value) {
																			echo '<tr><td>'.$value[0].'</td><td>'.$value[1].'</td><td><span class="btn btn-outline-danger text-dark btn-sm">Failed</span></td> </tr>';
																		}
																		echo '</table> </div> <hr>';
																	}
																...
																<tbody>'; 
																		foreach ($output['success'] as $value) {
																			echo '<tr><td>'.$value[0].'</td><td>'.$value[1].'</td><td><span class="btn btn-outline-success text-dark btn-sm">Success</span></td> </tr>';
																		}
																		echo '</table> </div> <hr>';
																	}
																?>																	
