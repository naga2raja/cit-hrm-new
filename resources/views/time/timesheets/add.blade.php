											...
											<form method="POST" action="" id="timesheets_form">												
												...
												<div class="col-sm-12 text-center">
													<div class="row">
														...
														<div class="col-sm-1">
															<a href="{{ route('systemUsers.index') }}" class="btn btn-theme button-1 text-white btn-block p-2 mb-md-0 mb-sm-0 mb-lg-0 mb-0"> Add Row</a>
														</div>
														<div class="col-sm-2">
															<a href="{{ route('systemUsers.index') }}" class="btn btn-danger text-white ctm-border-radius btn-block p-2 mb-md-0 mb-sm-0 mb-lg-0 mb-0"> Remove Row</a>
														</div>
														<div class="col-sm-1">
															<a href="{{ route('systemUsers.index') }}" class="btn btn-secondary text-white ctm-border-radius btn-block p-2 mb-md-0 mb-sm-0 mb-lg-0 mb-0">Reset</a>
														</div>
														<div class="col-sm-1">
															<a href="{{ route('systemUsers.index') }}" class="btn btn-secondary text-white ctm-border-radius btn-block p-2 mb-md-0 mb-sm-0 mb-lg-0 mb-0">Cancel</a>
														</div>
													</div>
												</div>
											</form>
	...
	window.onload = function() {
        ...
        $('#add').click(function(){
        	...
        	$rows += '<tr id="row_'+i+'">';
            	...
            	$rows += '</td>';
            	$rows += '<td>';
				    $rows += '<button type="button" name=timeItem['+i+']["remove"] id="'+i+'" class="btn btn-danger btn_remove">X</button>';
				$rows += '</td>';
			$rows += '</tr>';
