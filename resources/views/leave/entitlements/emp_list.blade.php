									...
									<div class="card-body">
										...
										<form id="searchEmployeeEntitlement" method="GET" action="{{ route('leaveEntitlement.index') }}">
											...
											<div class="row">
												...
												<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
													<button type="reset" class="mt-1 btn btn-danger text-white ctm-border-radius btn-block mt-4" onclick="resetAllValues('searchEmployeeEntitlement')"><i class="fa fa-refresh"></i> Reset </button>
												</div>
											</div>												
										</form>
									</div>
