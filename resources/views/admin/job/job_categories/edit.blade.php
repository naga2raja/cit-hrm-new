										...
										<div id="basic-one" class="collapse show ctm-padding" aria-labelledby="basic1" data-parent="#accordion-details">
											...
											<form method="POST" action="{{ route('jobCategory.update', $job_category->id) }}">
												...
												<div class="row">
													...
													<div class="col-sm-2">
														<div class="form-group">
															<input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" placeholder="" value="{{ old('name', $job_category->name) }}" autocomplete="off"  maxlength="20" minlength="3" id="job_category" onfocus="allowCharactersWithSpace('job_category')">
												...
												<div class="row">
													<div class="col-sm-3 text-center">
														<div class="row">
															...
															<div class="col-sm-6">
																<a href="{{ route('jobCategory.index') }}" class="btn btn-danger text-white ctm-border-radius btn-block p-2 mb-md-0 mb-sm-0 mb-lg-0 mb-0"> Cancel</a>
															</div>
														</div>
													</div>
												</div>
