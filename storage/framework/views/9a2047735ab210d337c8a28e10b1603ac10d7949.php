									...
									<div class="card office-card flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											<p class="d-inline-block mb-0">
												<a href="employment" class="avatar d-inline-block"><img src="img/profiles/img-6.jpg" alt="Maria Cotton" class="img-fluid"></a>
												<a href="employment" class="d-inline-block ml-4 text-primary">Maria Cotton</a>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="card flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											<div class="media mb-4">
												<img class="rounded mr-3 img-fluid" src="img/profiles/img-10.jpg" alt="avatar image" width="50" height="50">
												<div class="media-body">
													<a href="employment" class="text-dark text-ellipsis">Richard Wilson</a>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dleohr\template\resources\views/employment.blade.php ENDPATH**/ ?>