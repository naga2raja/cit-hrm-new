							...
							<div class="card-body">
								<ul class="activity-feed">
									<li class="feed-item">
										...
										<span class="feed-text"><a href="profile">John Doe</a> added new product <a href="product-details">"Smart Watch"</a></span>
									</li>
									<li class="feed-item">
										<div class="feed-date">Mar 21</div>
										<span class="feed-text"><a href="profile">Justin Lee</a> requested amount of <a href="invoice">$5,781</a></span>
									</li>
									<li class="feed-item">
										<div class="feed-date">Feb 2</div>
										<span class="feed-text">New user registered <a href="profile">"Mary Wiley"</a></span>
									</li>
									<li class="feed-item">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ventura_landing\template\resources\views/index.blade.php ENDPATH**/ ?>