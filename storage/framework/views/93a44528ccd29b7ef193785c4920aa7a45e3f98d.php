							...
							<div class="card shadow-sm ctm-border-radius">
								<div class="card-body align-center">
									...
									<ul class="nav nav-tabs float-right border-0 tab-list-emp">
										<li class="nav-item">
											<a class="nav-link border-0 font-23 grid-view" href="employees-offices"><i class="fa fa-th-large" aria-hidden="true"></i></a>
										</li>
										<li class="nav-item">
											<a class="nav-link border-0 font-23 active list-view" href="employees-offices-list"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
										</li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dleohr\template\resources\views/employees-offices-list.blade.php ENDPATH**/ ?>