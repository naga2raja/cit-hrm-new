										...
										<div class="proimage-wrap">
											<div class="pro-image" id="pro_popup">
												<a href="img/product/product-01.jpg">
													<img class="img-fluid" src="img/product/product-01.jpg" alt="Product Image">
												</a>
											</div>
											<ul class="proimage-thumb">
												<li>
													<a href="img/product/product-01.jpg"><img src="img/product/product-thumb-01.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="img/product/product-09.jpg"><img src="img/product/product-thumb-09.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="img/product/product-10.jpg"><img src="img/product/product-thumb-10.jpg" alt="Product Image"></a>
												</li>
												<li>
													<a href="img/product/product-11.jpg"><img src="img/product/product-thumb-11.jpg" alt="Product Image"></a>
												</li>
											</ul>
										</div>
									</div>
											...
											<div class="product-reviews">
												...
												<ul class="review-list">
													<li>
														<div class="review">
															<div class="review-author">
																<img class="avatar" alt="User Image" src="img/profiles/avatar-09.jpg">
															</div>
													...
													<li>
														<div class="review">
															<div class="review-author">
																<img class="avatar" alt="User Image" src="img/profiles/avatar-10.jpg">
															</div>
															<div class="review-block">
																<div class="review-by">
													...
													<li>
														<div class="review">
															<div class="review-author">
																<img class="avatar" alt="User Image" src="img/profiles/avatar-11.jpg">
															</div>
															<div class="review-block">
																<div class="review-by">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ventura_landing\template\resources\views/product-details.blade.php ENDPATH**/ ?>