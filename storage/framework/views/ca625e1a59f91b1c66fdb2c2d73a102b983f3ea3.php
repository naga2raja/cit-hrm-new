							...
							<aside class="sidebar sidebar-user">
								...
								<div class="card shadow-sm ctm-border-radius">
									<div class="card-header">
										...
										<a href="employees-team" class="float-right text-primary">Manage Teams</a>
									</div>
									<div class="card-body">
										<div class="row">
										...
										<div class="text-center">
											<a href="employees" class="btn btn-theme text-white ctm-border-radius mt-2 button-1">People Directory</a>
										</div>
									</div>
								</div>
								<div class="card ctm-border-radius shadow-sm">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dleohr-horizontal\resources\views/company.blade.php ENDPATH**/ ?>