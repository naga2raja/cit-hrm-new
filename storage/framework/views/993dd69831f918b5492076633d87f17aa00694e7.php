    ...
    <header class="header">
                            ...
                            <div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
                                <div class="append mr-auto my-0 my-md-0 mr-auto">
                                    <ul class="list-group list-group-horizontal-md mr-auto">
                                        <li class="mr-1 <?php echo e(Request::is('index','employees-dashboard') ? 'active' : ''); ?>"><a href="index" class="btn-ctm-space text-dark header_class"><span class="lnr lnr-home pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Dashboard</span></a></li>
                                        ...
                                        <li class="mr-1 <?php echo e(Request::is('leave') ? 'active' : ''); ?>"><a class="btn-ctm-space text-dark" href="leave"><span class="lnr lnr-briefcase pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Leave</span></a></li>
        ...
        <!-- /Header --><?php /**PATH C:\xampp\htdocs\dleohr\template-1\dleohr-horizontal\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>