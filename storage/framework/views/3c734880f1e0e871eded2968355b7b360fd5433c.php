							...
							<div class="card shadow-sm ctm-border-radius">
								<div class="card-body align-center">
									...
									<ul class="nav nav-tabs float-right border-0 tab-list-emp">
										<li class="nav-item">
											<a class="nav-link active border-0 font-23 grid-view" href="employees"><i class="fa fa-th-large" aria-hidden="true"></i></a>
										</li>
										<li class="nav-item">
											<a class="nav-link border-0 font-23 list-view" href="employees-list"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
										</li>
												...
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-6.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Maria Cotton</a></h4>
																<div>
											...
											<div class="card widget-profile">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-5.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Danny Ward</a></h4>
																<div>
											...
											<div class="card widget-profile">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-4.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Linda Craver</a></h4>
																<div>
											...
											<div class="card widget-profile">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-3.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Jenni Sims</a></h4>
																<div>
											...
											<div class="card widget-profile">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-2.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">John Gibbs</a></h4>
																<div>
											...
											<div class="card widget-profile">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-8.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Stacey Linville</a></h4>
																<div>
											...
											<div class="card widget-profile last-card-row">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-10.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Richard Wilson</a></h4>
																<div>
											...
											<div class="card widget-profile last-card-row">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-15.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Daniel Griffing</a></h4>
																<div>
											...
											<div class="card widget-profile last-card-row1">
												<div class="card-body">
													<div class="pro-widget-content text-center">
														<div class="profile-info-widget">
															<a href="employment" class="booking-doc-img">
																<img src="img/profiles/img-14.jpg" alt="User Image">
															</a>
															<div class="profile-det-info">
																<h4><a href="employment" class="text-primary">Michelle Fairfax</a></h4>
																<div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dleohr\template\resources\views/employees.blade.php ENDPATH**/ ?>