					...
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
							<aside class="sidebar sidebar-user">
								...
								<div class="card ctm-border-radius shadow-sm">
									<div class="card-body">
										<a href="create-review" class="btn btn-theme button-1 ctm-border-radius text-white btn-block"><span><i class="fa fa-plus"></i></span> Create Review</a>
									</div>
								</div>
															...
															<tr>
																...
																<td>
																	<div class="table-action">
																		<a href="edit-review" class="btn btn-sm btn-outline-success">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dleohr\template\resources\views/reviews.blade.php ENDPATH**/ ?>