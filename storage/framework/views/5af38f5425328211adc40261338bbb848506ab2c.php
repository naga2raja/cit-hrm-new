    ...
    <header class="header">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                            ...
                                            <div class="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item p-2" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" >
                                                    <span class="media align-items-center">
        ...
        <!-- /Header --><?php /**PATH D:\xampp\htdocs\cithrm-new\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>