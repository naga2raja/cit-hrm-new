								...
								<div class="user-card shadow-sm bg-white p-4 text-center ctm-border-radius card">
									<div class="user-info">
										...
										<div class="user-details">
											...
											<span class="ctm-text-sm"><?php echo e(Auth::user()->email); ?></span>
										</div>
									</div>
								</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\cithrm-new\resources\views/profile-settings.blade.php ENDPATH**/ ?>