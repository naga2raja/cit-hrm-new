...
class ProjectsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $projects = mProject::select(DB::raw('GROUP_CONCAT( DISTINCT m_customers.customer_name) as customer_name'),DB::raw("CONCAT_WS(' ', employees.first_name, employees.middle_name, employees.last_name) as admin_name"), 'm_projects.id as project_id', 'm_projects.project_name as project_name')
    ...
    public function edit($id)
    {
        ...
        $projects = $projects = mProject::select('m_projects.id','m_projects.project_name', 'm_projects.project_description', 'm_projects.customer_id', 'm_customers.customer_name', 't_project_admins.admin_id',DB::raw("CONCAT_WS(' ', employees.first_name,' ',employees.middle_name,' ',employees.last_name) as admin_name"))
                ->join('m_customers', 'm_projects.customer_id', 'm_customers.id')
                ->leftjoin('t_project_admins', 't_project_admins.project_id', 'm_projects.id')
                ->leftjoin('employees', 'employees.id', 't_project_admins.admin_id')
